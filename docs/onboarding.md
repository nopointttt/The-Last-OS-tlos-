...
1. [manifesto.md](product/manifesto.md)
2. [whitepaper.md](product/whitepaper.md)
3. [sovereign_model.md](product/sovereign_model.md)
4. [architecture.md](technical/architecture.md)
5. [documentation_hub.md](technical/documentation_hub.md) (обзор технических документов)
6. [kernel_api.md](technical/kernel/kernel_api.md)
7. [network.md](technical/protocol/network.md)
8. [security.md](technical/kernel/security.md)
9. [contributing.md](technical/contributing.md)

### Трек B: AI-агент / Разработчик агентов (≈ 1.5 часа)
1. [manifesto.md](product/manifesto.md)
2. [sovereign_model.md](product/sovereign_model.md)
3. [agent_ecosystem.md](technical/agent_ecosystem.md)
4. [kernel_api.md](technical/kernel/kernel_api.md) (раздел MCP)
5. [security.md](technical/kernel/security.md) (AI-specific threats)
6. [zero_web2_standards.md](technical/zero_web2_standards.md)
7. [contributing.md](technical/contributing.md) (раздел “Deep Sync”)

### Трек C: Инвестор / Партнёр / Бизнес (≈ 1 час)
1. [manifesto.md](product/manifesto.md)
2. [whitepaper.md](product/whitepaper.md)
3. [sovereign_model.md](product/sovereign_model.md)
4. [use_cases.md](product/use_cases.md)
5. [economy_and_intelligence.md](product/economy_and_intelligence.md)
6. [gamification.md](product/gamification.md)
7. [social_and_identity.md](product/social_and_identity.md)

### Трек D: Новый пользователь / Тестировщик (≈ 45 мин)
1. [manifesto.md](product/manifesto.md)
2. [spatial_experience.md](product/spatial_experience.md)
3. [use_cases.md](product/use_cases.md)
4. [sovereign_model.md](product/sovereign_model.md)
5. [gamification.md](product/gamification.md)
